...
public class LearningExtentReport {
	...
	public void login() {
		...
		test.pass(MediaEntityBuilder.createScreenCaptureFromPath(screenCapture("Launch Application"), "HomePage")
				.build());
		...
		if (currentURL.equalsIgnoreCase("://demowebshop.tricentis.com/")) {
			...
			test.fail(
					MediaEntityBuilder.createScreenCaptureFromPath(screenCapture("URL mismatch"), "HomePage").build());
